...
@section('content')
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-lg shadow-lg p-8">
            <h2 class="text-3xl font-bold text-[#1e3a8a] mb-6"><i class="fas fa-calendar-plus"></i> Buat Agenda Baru</h2>
            ...
            <form action="{{ route('agenda.store') }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="judul" id="judul" 
                        ...
                        placeholder="Contoh: Rapat Ramadhan 2026" value="{{ old('judul') }}" required>
                    @error('judul')
                ...
                <div class="flex gap-3">
                    <button type="submit" class="flex-1 bg-gradient-to-r from-[#3b82f6] to-[#1e3a8a] hover:from-[#1e3a8a] hover:to-[#0f172a] text-white font-bold py-3 rounded-lg transition transform hover:scale-105">
                        <i class="fas fa-save"></i> Buat Agenda
                    </button>
                    <a href="{{ route('agenda.index') }}" class="flex-1 bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-3 rounded-lg text-center transition">
