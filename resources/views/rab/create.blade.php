                        ...
                        <tbody id="rabTableBody">
                            <tr class="rab-item-row" data-row="0">
                                ...
                                <td class="border border-gray-300 px-2 py-2 text-center bg-blue-50">
                                    <input type="checkbox" name="items[0][surat_tugas]" class="surat-tugas-checkbox" value="1">
                                </td>
                                <td class="border border-gray-300 px-2 py-2 text-center bg-blue-50">
                                    <input type="checkbox" name="items[0][laporan]" class="laporan-checkbox" value="1">
                                </td>
                                ...
                                <td class="border border-gray-300 px-2 py-2 text-center bg-green-50">
                                    <input type="checkbox" name="items[0][ktp]" class="ktp-checkbox" value="1">
                                </td>
                                <td class="border border-gray-300 px-2 py-2 text-center bg-green-50">
                                    <input type="checkbox" name="items[0][npwp]" class="npwp-checkbox" value="1">
                                </td>
                                <td class="border border-gray-300 px-2 py-2 text-center">
                ...
                <div class="p-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <textarea 
                            ...
                            placeholder="Nama dan jabatan pemohon/ketua tim kerja">{{ old('nama_pemoton') }}</textarea>
                    </div>
